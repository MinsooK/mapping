...
int main(int argc, char **argv)
{
    ...
    int scan_line = 64;
    double vertical_angle = 54.0;
    double scan_period= 0.08;
    double max_dis = 25.0;
    double min_dis = 0.1;
...
//    ros::Subscriber subLaserCloud = nh.subscribe<sensor_msgs::PointCloud2>("/VICSEN/points", 100, lidarHandler);
    ros::Subscriber subLaserCloud = nh.subscribe<sensor_msgs::PointCloud2>("/ifwslidar", 100, lidarHandler);

    pubLaserCloudFiltered = nh.advertise<sensor_msgs::PointCloud2>("/points_filtered", 100);
